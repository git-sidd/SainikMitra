...
const Navbar = () => {
  ...
  return (
    <div className='flex fix justify-start md:items-center md:justify-center sticky top-0 z-[60]   h-[45px] bg-black '>
        
      <nav>
        
        <ul className={`flex items-center justify-around  gap-4 md:gap-8 ${navbarOpen ? 'flex-col  h-[200px] opacity-80 bg-blend-overlay bg-black/70 w-full absolute top-[45px]' : 'hidden md:flex'}`}>
